...
void ADC_IRQHandler(void)//�Ӻ�4us  ��ִ��2.16us
{
...
extern uint16_t center;    // ����ֵ1500
extern uint16_t amp;        // ���500
//u16 g_u16AD7949_rxBuf[ADC_CHANNEL_NUM * ADC_FILTER_FIFO] = {0};
void SysTick_Handler(void)//100us
{ 
	
			Cal_MCU_AvgAdcVal_Fun();      // ģ��������
      TransAD7689DataIntoFIFO();   // AD���ݰ���
			CalAD7689AvgAngPrsData();    // �˲�����
      Cal_SolenoidCur();           // ��������
			Cal_PrsFbkDiff_Func();       // ѹ��΢��
      Cal_AngFbkDiff_Func();       // �Ƕ�΢��
      CalAngFbkDiff_InPrsLoop_Func();
			TiltAngleLoop_Func();        // �����㷨
			TimPeriodCnt_Func();
