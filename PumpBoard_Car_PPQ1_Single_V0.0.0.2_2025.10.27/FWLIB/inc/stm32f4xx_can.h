...
typedef struct
{
  ...
  uint8_t Recv_canopen_Flag; //canopen 接受完成标志位

  uint8_t Recv_j1939_Flag; //canopen 接受完成标志位
} CanRxMsg;
...
void CAN_Receive_j1939(CAN_TypeDef* CANx, uint8_t FIFONumber, CanRxMsg* RxMessage);
